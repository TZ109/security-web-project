<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
		...
		min-height:80px;">
						...
						<div style="position: relative;top:100px; padding-bottom:20px;">
                        <div style="position: relative;width:90%;margin-left:auto;margin-right: auto;text-align: center;">
                            <p style="font: normal normal bold 48px/48px Noto Sans KR;">문의하기</p>
                        </div>

                        <div style="position: relative;">
                            <hr style="height: 5px;width: 90%;border-radius: 10px; background-color: #245AE3;">
                        </div>

                        <div style="position: relative;width:90%;text-align: center;margin-left:auto;margin-right: auto;">
...
<form action="/user/updatecustomer" method="post" id="send" enctype="multipart/form-data">
	...
	console.log(`${body}`);
		oEditors.getById["txtContent"].exec("LOAD_CONTENTS_FIELD"); // 에디터에 내용 삽입
                        ...
                        <div style="position: relative; margin-top:20px;margin-left:11%;width: 82px;height: 33px;border: 1px solid #707070;
                        border-radius: 8px;">
						...
						<div style="position:relative;width:80%;display:flex;margin-left:auto;margin-right: auto;margin-top:60px; justify-content: center;">
                        ...
                        <a href="/customerCenter" style="text-decoration:none">
                        <div style="padding-top:1px;padding-bottom:11px;width: 141px;height: 36px;background: #E5E5E5 0% 0% no-repeat padding-box;
                        border-radius: 8px;">
                        <p style="text-align: center;font: normal normal medium 14px/10px Noto Sans KR;letter-spacing: 0px;color: #FFFFFF;">목록 보기</p>
                        </div>
						</div>
                    </div>
