										...
										<div id="remote_2">
											...
											<div id="back_View"
												...
												<div id="first_Sign_View"
													style="display:none;text-align:center;background-color: #ffffff;border-radius: 25px; width:210px;padding-top: 5px;padding-bottom: 5px;margin-left: 15px;margin-bottom: 15px;">


													<div
														style="font: normal normal bold 15px/17px Noto Sans KR;">
												...
												<div id="second_Sign_View"
													style="display:none;text-align:center;text-align:center;background-color: #ffffff;border-radius: 25px; width:210px;padding-top: 5px;padding-bottom: 5px;margin-left: 15px;margin-bottom: 15px;">
											...
											<div id="other_View" style="display:none">
												...
												<div style="display:flex;text-align: center;justify-content: center;">
													...
													<sec:authorize access="isAuthenticated()">
														...
														<form method="post" action="/user/deletedocument" id="deldocu">
															<input type="hidden" name="serial" value="${uniquenum}">
															<input id="btnout" type="button" onclick="$('#deldocu').submit();"
