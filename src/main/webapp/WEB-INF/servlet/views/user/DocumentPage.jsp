							...
							<div id="controller_background_gray">
								...
								<div id="remote_2">
									...
									<div id="input" style="display:flex;justify-content: center;visibility:hidden">
										<input id="input_doc" type="image" src="/img/document_on.svg"
											style="margin-right:15px;" onclick="click_inputfile(this)" />
										<a onclick="test()" id="input_sign_ancher"><img src="/img/sign_on.svg"
									...
									<form action="/user/makeSign" method="post" id="submit_form"
										...
										<div id="first_Sign_View"
											...
											<br>
											<div><img src="/img/참여자1.png" style="text-align:left" alt="참여자1"></div>
											<br>
								...
								<div id="remote_1" style="display:flex;flex-direction:column;justify-content:center;">
									<div id="init" style="display:none;flex-direction:column;align-items: center;justify-content:center;">
										...
										<br><input type="button" style="width:auto" value="참여자 1 서명 더하기"
										...
										<br><input type="button" id="plus2" style="width:auto;visibility: hidden;"
											value="참여자 2 서명 더하기" onclick="add_img_layer('sign',1); this.onclick=null;"  class="button" /><br>
										<br><input type="button" id="plus3" style="width:auto;visibility: hidden;"
											value="참여자 3 서명 더하기" onclick="add_img_layer('sign',2); this.onclick=null;"  class="button" /><br>
