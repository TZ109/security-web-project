...
<div id="Page" style="width: 100%;">
     <div id = "Controll_Layer" style="width: 97%;">
		<nav class="navbar" style="width:100%;display: flex;justify-content: space-between;align-items: center;padding: 8px 12px;max-height:80px;
		min-height:80px;">
		<a href="/">
		...
		<ul class="button_layer" style="display: flex;list-style : none; padding-left : 0;">
			...
			<li> <a onclick="location.href='/board'" class="btn5" style="cursor: pointer;white-space:nowrap"> 자료실 </a> </li> 
			<li> <a onclick="location.href='/customerCenter'" class="btn5" style="cursor: pointer;white-space:nowrap"> 고객센터 </a> </li>
			
				<sec:authorize access="isAnonymous()">
					<li> <a  href="/joinForm" class="btn7" style="cursor: pointer; text-decoration:none;white-space:nowrap"> 회원가입 </a> </li>
					<li> <a href="/loginForm" class="btn6" style="cursor: pointer; text-decoration:none;white-space:nowrap"> 로그인 </a> </li>
				</sec:authorize>
	 ...
	 <div style="position:absolute; top:156px; width:100%; text-align: center;">

		<img src="/img/bi)바로날인beta_KR.png" style="width: 260px;height: 111px;"/>
		...
		<!--  </form>-->
			...
			<p style="display:none; color: red; width:400px; text-align:left; margin-top: 2px; margin-bottom: 6px; margin-left: auto; margin-right: auto;" id="idPoss">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;사용 가능한 아이디입니다.
			</p>
			
			<p style="display:none; color: red; width:400px; text-align:left; margin-top: 2px; margin-bottom: 6px; margin-left: auto; margin-right: auto;" id="idImposs">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;해당 아이디는 이미 사용 중 입니다.
			</p>
			
			<p style="display:none; color: red; width:400px; text-align:left; margin-top: 2px; margin-bottom: 6px; margin-left: auto; margin-right: auto;" id="idNeqEmail">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이메일을 아이디로 입력하십시오.
			</p>
			
			<p style="display:none; color: red; width:400px; text-align:left; margin-top: 2px; margin-bottom: 6px; margin-left: auto; margin-right: auto;" id="idEmpty">
		...
		<div style="margin-top:30px; display: flex; width:300px; margin-left: auto; margin-right: auto;">
			<input type="checkbox" style='zoom:2.0; margin:0' id="sign_check">
			<font style="font: normal normal normal 14px/26px Noto Sans KR;padding-left:8px">개인정보 수집 및 이용약관에 동의합니다.</font>
		</div>
	
		<input type="button" id="button" value="저장"  onclick="submit_form()" class="btn2" style="margin-top:30px;width:172px;height:54px;">
