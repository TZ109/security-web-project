	...
	public void sendMail() throws MessagingException, IOException {
	    ...
	    private String build(Article article)
	    {
	    	...
	    	String temp= "<!DOCTYPE html>\n"
					...
					+"<form target=\"_blank\" action='http://14.45.111.226:8090/user/DocumentcheckPage' method='post'>"
	    ...
	    private String build2(Article article)
	    {
			...
			String temp = "<!DOCTYPE html>\n"
					...
					+ "    <form action='http://14.45.111.226:8090/user/Documentcomplete2' method=\"post\" >\n"
